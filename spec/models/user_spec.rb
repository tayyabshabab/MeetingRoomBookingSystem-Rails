...
describe User do
  ...
  before do
    @user = User.new(name: "Tayyab", email: "tayyabshabab@yahoo.com", password: "test123",
  ...
  describe "booking associations" do
    ...
    it "should have the right bookings in the right order" do
      expect(@user.bookings.to_a).to eq [booking_one, booking_two]
    end

    it "should destroy associated bookings" do
      bookings = @user.bookings.to_a
      @user.destroy
